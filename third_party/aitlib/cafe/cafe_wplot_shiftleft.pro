...
;
; DESCRIPTION:
;           Shift viewed portion left by 75% of displayed plot range.
;               
; SIDE EFFECTS:
...
;
; HISTORY:
;           $Id: cafe_wplot_shiftleft.pro,v 1.9 2003/04/28 07:45:10 goehler Exp $
;             
;-
;
; $Log: cafe_wplot_shiftleft.pro,v $
...
PRO cafe_wplot_shiftleftevent, ev
...
;; ------------------------------------------------------------
;; SHIFTLEFT - THE MAIN FUNCTION WHICH ALLOCATES A NEW BUTTON
;; ------------------------------------------------------------

PRO cafe_wplot_shiftleft,env,  baseID,  help=help, shorthelp=shorthelp

    ;; command name of this source (needed for automatic help)
    name="wplot_shiftleft"
    ...
    IF keyword_set(shorthelp) THEN BEGIN  
        print, "shiftleft   - shift left button"
        return
    ENDIF


    buttonID= widget_button(baseID, value="  <<  ", $
                            event_pro="cafe_wplot_shiftleftevent")
