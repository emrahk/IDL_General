...
;
; PURPOSE:
;           Button to rotate 3-dim pictures around X axis up.
;
; CATEGORY:
;           cafe
;
...
;
; DESCRIPTION:
;           Rotate displayed plot window 5deg up.
;               
; SIDE EFFECTS:
...
;
; HISTORY:
;           $Id: cafe_wplot_rotup.pro,v 1.6 2003/04/28 07:45:09 goehler Exp $
;             
;-
;
; $Log: cafe_wplot_rotup.pro,v $
...
;; ------------------------------------------------------------
;; ROTUP - THE MAIN FUNCTION WHICH ALLOCATES A NEW BUTTON
;; ------------------------------------------------------------

PRO cafe_wplot_rotup,env,  baseID,  help=help, shorthelp=shorthelp
    ...
    IF keyword_set(shorthelp) THEN BEGIN  
        print, "rotup   - rotate up button"
        return
    ENDIF


    buttonID= widget_button(baseID, value="  rot ^ ", $
                            event_pro="cafe_wplot_rotupevent")
