FUNCTION  cafe_model_floor, x, parameter, env=env,$
                  getparam=getparam, $
...
;
; PURPOSE:
;           Returns closest integer value below x value
;
; CATEGORY:
;           CAFE
; 
...
;
; HISTORY:
;           $Id: cafe_model_floor.pro,v 1.6 2002/09/10 13:24:31 goehler Exp $
;-
;
; $Log: cafe_model_floor.pro,v $
...
;
  ...
  IF KEYWORD_SET(SHORTHELP) THEN BEGIN  
      PRINT, "floor - closest integer number below value"
      RETURN, 0
  ENDIF
