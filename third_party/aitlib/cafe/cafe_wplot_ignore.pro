...
;
; PURPOSE:
;           Button to ignore selected data points
;
; CATEGORY:
;           cafe
;
...
;
; DESCRIPTION:
;           Ignore selected data points in current group.
;               
; SIDE EFFECTS:
;           Changes defined flag for data points.
;
;
; HISTORY:
;           $Id: cafe_wplot_ignore.pro,v 1.9 2003/04/28 07:45:08 goehler Exp $
;             
;-
;
; $Log: cafe_wplot_ignore.pro,v $
...
;
; Revision 1.7  2003/03/17 14:11:39  goehler
...
;
; Revision 1.5  2002/09/10 13:24:34  goehler
...
PRO cafe_wplot_ignoreevent, ev
    ...
    ;; report command:
    cafereport,env,'ignore, "selected"',/nocomment

    ;; ignore selected datapoints:
    cafe_ignore,env,"selected"    
...
;; ------------------------------------------------------------
;; IGNORE - THE MAIN FUNCTION WHICH ALLOCATES A NEW BUTTON
;; ------------------------------------------------------------

PRO cafe_wplot_ignore,env,  baseID,  help=help, shorthelp=shorthelp
    ...
    IF keyword_set(shorthelp) THEN BEGIN  
        print, "ignore   - ignore selected datapoints"
        return
    ENDIF


    buttonID= widget_button(baseID, value="Ignore", $
                            event_pro="cafe_wplot_ignoreevent")
