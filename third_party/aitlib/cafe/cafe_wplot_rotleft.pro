...
;
; PURPOSE:
;           Button to rotate 3-dim pictures clockwise
;
; CATEGORY:
;           cafe
;
...
;
; DESCRIPTION:
;           Rotate displayed plot window 10deg left.
;               
; SIDE EFFECTS:
;           Changes view of displayed plot. For this setplot parameter
;           "AZ" will be decreased by 10. 
;
;
; HISTORY:
;           $Id: cafe_wplot_rotleft.pro,v 1.6 2003/04/28 07:45:09 goehler Exp $
;             
;-
;
; $Log: cafe_wplot_rotleft.pro,v $
...
PRO cafe_wplot_rotleftevent, ev
...
;; ------------------------------------------------------------
;; ROTLEFT - THE MAIN FUNCTION WHICH ALLOCATES A NEW BUTTON
;; ------------------------------------------------------------

PRO cafe_wplot_rotleft,env,  baseID,  help=help, shorthelp=shorthelp
    ...
    IF keyword_set(shorthelp) THEN BEGIN  
        print, "rotleft   - rotate left button"
        return
    ENDIF


    buttonID= widget_button(baseID, value="<-rot  ", $
                            event_pro="cafe_wplot_rotleftevent")
