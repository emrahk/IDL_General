...
;
; PURPOSE:
;           Button to change viewport to right
;
; CATEGORY:
;           cafe
;
...
;
; DESCRIPTION:
;           Step viewed portion right by 10% of displayed plot range.
;               
; SIDE EFFECTS:
...
;
; HISTORY:
;           $Id: cafe_wplot_stepright.pro,v 1.9 2003/04/28 07:45:11 goehler Exp $
;             
;-
;
; $Log: cafe_wplot_stepright.pro,v $
...
PRO cafe_wplot_steprightevent, ev
...
;; ------------------------------------------------------------
;; STEPRIGHT - THE MAIN FUNCTION WHICH ALLOCATES A NEW BUTTON
;; ------------------------------------------------------------

PRO cafe_wplot_stepright,env,  baseID,  help=help, shorthelp=shorthelp

    ;; command name of this source (needed for automatic help)
    name="wplot_stepright"
    ...
    IF keyword_set(shorthelp) THEN BEGIN  
        print, "stepright   - step right button"
        return
    ENDIF


    buttonID= widget_button(baseID, value="  |>  ", $
                            event_pro="cafe_wplot_steprightevent")
