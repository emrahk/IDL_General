PRO plotcolor,files,path=path,channels=channels,comp_channel=comp_channel, $
...
;
; CALLING SEQUENCE:
;       plotcolor,files,path=path,channels=channels,comp_channel=comp,
...
;       cc = 2
;       fadd = [0,2]
;       plotcolor,files,path=pfad,channels=ch,comp_channel=cc, $
