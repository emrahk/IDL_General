...
CD, Current=startdir
IF N_Elements(dirname) EQ 0 THEN dirname = startdir ELSE BEGIN
   IF StrMid(dirname, 0, 2) EQ ".." THEN BEGIN
      CASE StrUpCase(!Version.OS_Family) OF
      'MACOS': BEGIN
         CD, '..'
         CD, Current=basename
         dirname = basename + StrMid(dirname, 3)
         CD, startdir
         END
      'VMS': BEGIN
         CD, '..'
      ...
      ELSE: BEGIN
         CD, '..'
         CD, Current=basename
         dirname = basename + StrMid(dirname, 2)
         CD, startdir
         END
      ENDCASE
   ENDIF
   IF StrMid(dirname, 0, 1) EQ "." THEN BEGIN
      CASE StrUpCase(!Version.OS_Family) OF
      'MACOS': BEGIN
         CD, Current=basename
         dirname = basename + StrMid(dirname, 2)
      ...
      ELSE: BEGIN
         CD, Current=basename
         dirname = basename + StrMid(dirname, 1)
         CD, startdir
      END
      ENDCASE
   ENDIF
...
CD, Current=thisDir
filenameID = FSC_FileSelect(tlb, Directory=thisDir, Filename='fsc_fileselect.pro', $
