...
; MODIFICATION HISTORY:
;       Revision 1.5 2001/01/11 Joern Wilms
;          wilms@astro.uni-tuebingen.de
;       changed call to strtok to call to mc_strtok to avoid clash
;       with internal (?) IDL 5.3 function
;
;       $Id: translate_sub_super.pro,v 1.4 1996/06/14 20:00:27 mcraig Exp $
;       $Log: translate_sub_super.pro,v $
;       Revision 1.4  1996/06/14 20:00:27  mcraig
...
; '_', then process the script we've found.
    NewString=mc_strtok(strn,Token)
