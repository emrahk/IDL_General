pro amev_stor,dc_,opt_,accum_,counts_,lvtme_,idfs_,idfe_,disp_,$
                a_counts_,a_lvtme_,det_,cp_,dt_,num_dets_,$
                pha_edgs_,num_tm_bins_,pha_choice_,ltime_,ft_,$
                periods_,fold_,fnme_,phz_bns_
;***************************************************************************
; Program loads the Archive Multiscalar data variables into the 
