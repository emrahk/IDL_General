...
; wam.pro, and communicates to the manager program
; am.pro via common block variables
;           dc.................detector code
;           cp.................cluster position
...
;    idf_lvtme.................array of idfs vs livetime
; Common blocks:
...
common amev_block,dc,opt,accum,counts,lvtme,idfs,idfe,$
...
; Return option
;************************************************************************
   if(value eq 'TO ARCMSCLR')then begin
      ft = 0 
      fold = 0
      value = 'UPDATE'
   endif
