...
common oldulds,xulds_old,ulds_old,arms_old,trigs_old,vetos_old,$
               idfarr_old
;********************************************************************
...
nai_only = 0 & phz_arr = 0 & ra = 0. & dec = 0. & num = 0
prms = 0. & go = 0 & prms_save = 0. & burst = 0 & ulds_old = 0. 
old_xulds = 0. & idfarr_old = 0. & arms_old = 0 & trigs_old = 0 
vetos_old = 0 & a_tedgs = 0d & tedgs = 0d
;********************************************************************
; That's all ffolks 
;********************************************************************
return
