pro plot_calhist,file

;  ***********************************************************************
;  Plot a set of 4 calibration histograms given a .asc file saved from 
;  get_accum or xs
;  ***********************************************************************
...
if (n_params() eq 0) then begin
  print,'USAGE:  plot_calhist,''filename'' '
  return
endif
...
x=indgen(128)
for i=0,3 do begin 
  plot,x,rate(i,*),yrange=[0,85],psym=10,$
     xtitle='channel',ytitle='cts/sec', $
     title='Detector '+strtrim(string(i+1),2)+' calibration histogram'
endfor
