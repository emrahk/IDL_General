...
; EXPLANATION:
;     This version of FITSDIR requires V5.3 or later
;
...
;-
 ...
 if N_elements(keywords) EQ 1 then $
  ...
  1: alt1_keys = strupcase(strsplit(alt1_keywords[0],',',/EXTRACT)) 
  ...
  1: alt2_keys = strupcase(strsplit(alt2_keywords,',',/EXTRACT)) 
 ...
 if N_elements(alt2_set) EQ 0 then alt2_set = strlen(strtrim(alt2_keys,2)) GT 0
  ...
  1: alt3_keys = strupcase(strsplit(alt3_keywords,',',/EXTRACT)) 
