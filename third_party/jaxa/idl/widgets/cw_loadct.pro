...
;
; Version     : Version 5, 8 April 1998
;-            


;; This procedure was snatched from itool_adj_ctable
;;
PRO cw_loadct_adj_ctable, event, initialize=initialize
...
PRO cw_loadct_newstart,ev
  ...
  cw_loadct_adj_ctable,/initialize
END

PRO cw_loadct_reverse,ev
...
FUNCTION cw_loadct,base,xsize=xsize,ysize=ysize,frame=frame,file=file,$
                   menu=menu,font=font
  ...
  ibase=WIDGET_BASE(base,/column,event_pro='cw_loadct_newstart',frame=frame,$
  ...
  bar = WIDGET_DRAW(ibase,xsize=xsize,ysize=ysize,/button_events,$
                    event_pro='cw_loadct_event',$
                    notify_realize='cw_loadct_realize')
