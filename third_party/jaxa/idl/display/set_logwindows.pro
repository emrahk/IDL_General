...
;		08-Dec-2010 - Richard Schwartz - increase setenv_str from 2000 to 4000
;				when ksetenv gets to 4000, drop it back to 3000 and overwrite last
;				1000 entries
;
;-
...
if n_elements(setenv_str) eq 0 then begin
   setenv_str = strarr(4000) ; ras, increased from 2000, 8-dec-2010
   ksetenv = 0
endif
nenv_str = n_elements(setenv_str)
...
;       recursively resolve any $xxx variables...
         ...
         if ksetenv eq nenv_str then ksetenv= ksetenv-1000 ;overwrite last 1000 entries, ras, 8-dec-2010
