	PRO WDISPLAY,IMAGE,NOSCALE=NOSCALE,WINDOW=WINDOW,NOEXACT=NOEXACT, $
		...
		TOP=TOP,BOTTOM=BOTTOM,VELOCITY=VELOCITY,COMBINED=COMBINED,$
                LOWER=LOWER,RESIZE=RESIZE,RELATIVE=RELATIVE,ORIGIN=ORIGIN,$
                SCALE=SCALE,DATA=DATA,TITLE=TITLE,TRUE=K_TRUE,PIXMAP=PIXMAP,$
                BSCALED=BSCALED
;+
; Project     : SOHO - CDS
;
...
;       Version 8, William Thompson, GSFC, 10-May-2012, added keyword PIXMAP
; Version     : 
...
;
	...
	IF ALLOCATE_FREE THEN BEGIN
                WINDOW, XSIZE=MX, YSIZE=MY, /FREE, TITLE=TITLE, PIXMAP=PIXMAP
		WINDOW = !D.WINDOW
	END ELSE WINDOW, XSIZE=MX, YSIZE=MY, WINDOW, TITLE=TITLE, PIXMAP=PIXMAP
;
...
;
	EXPAND_TV,IMAGE,NOSCALE=NOSCALE,MX,MY,0,0,/NOBOX,/DISABLE,	$
		...
		ORIGIN=ORIGIN,SCALE=SCALE,TRUE=K_TRUE,BSCALED=BSCALED
