...
FUNCTION rpc_idl_variable::xdr_vector, xdr, vector, TYPE = type
...
FUNCTION rpc_idl_variable::set_value, name, val
...
FUNCTION rpc_idl_variable::get_value
...
FUNCTION rpc_idl_variable::xdr_idl_variable, xdr
...
FUNCTION rpc_idl_variable::init
...
PRO rpc_idl_variable__define

struct = {RPC_IDL_VARIABLE,                       $
          name:              PTR_NEW (),      $
          type:              PTR_NEW (),      $
          flags:             PTR_NEW (),      $
          elt_len:           PTR_NEW (),      $
