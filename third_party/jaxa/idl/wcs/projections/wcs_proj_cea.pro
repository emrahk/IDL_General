...
;-
;
pro wcs_proj_cea, wcs, coord, missing=k_missing, nowrap=nowrap
on_error, 2
halfpi = !dpi / 2.d0
;
...
;
;  Get the cylindrical radius lambda.  If not found, use the default of 1.
;
lambda = 1.d0
if tag_exist(wcs, 'proj_names', /top_level) then begin
...
;
;  Make sure that the lambda value is valid.
;
