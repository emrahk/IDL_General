...
;-
;
pro wcs_proj_coe, wcs, coord, missing=k_missing
on_error, 2
halfpi = !dpi / 2.d0
;
...
theta1 = thetaA - eta
theta2 = thetaA + eta
gamma = sin(theta1) + sin(theta2)
c = gamma / 2.d0
y0 = sqrt(1.d0 + sin(theta1)*sin(theta2) - gamma*sin(thetaA)) / c
...
theta = asin(1.d0/gamma + sin(theta1)*sin(theta2)/gamma - gamma*(r_theta/2.d0)^2)
;
