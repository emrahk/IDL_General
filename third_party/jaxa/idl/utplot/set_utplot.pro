...
; 31-Aug-2015, Kim Tolbert. - In setting tick_units, ensure that calculations are done in dbl prec
;  rather than converting to dbl at end.  This caused incorrect placement of the tick marks on plots 
;  with a very small time range (when major ticks were .02 s apart).
;  - Also used idlv4_to_v5 to convert parentheses to square brackets.
; 9-Nov-2015, Kim. Revert back to this version after putting a faulty version online.
;  
;-
...
; 31-Aug-2015, Kim changed this commented out code to the following code 
...
tick_units=1.d0 * [10^dindgen(5)*1.0d-3,10^dindgen(4)*.002d,10^dindgen(4)*.005d,$
  20.,30.,60.,60.*[2,4,5,6,10,15,20,30,60],3600.*[2.+dindgen(5),8.,10.,12.],$
  86400.*[dindgen(6)+1.,10.,20.,30.,60.]]
