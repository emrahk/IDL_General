pro coldat_1655deb,ind,eb,fpeak,qpo,rmsiz,rmstz,trmsi,trmst

root1='/raid1/ekalemci/DATA239/1655/'
root2=['P25.00/an/','P26.00/an/']

file3_1=['threelor_e1n.dat','threelor_e1n.dat']
file3_2=['threelor_e2n.dat','threelor_e2n.dat']

if eb eq 1 then files=root1+root2+file3_1
if eb eq 2 then files=root1+root2+file3_2
