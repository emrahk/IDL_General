pro fit_brpl_2lfffa,p,p_err,f_b,a1,a2,a3,ff,fa,fit,guess
...
modelname = 'brk_pow_2lfffa' ; the model name should also go here
...
f(g1) = a(0) +  (a(3)*a(4))/(2.0*!pi*den1(g1)) + (fa*a(6))/(2.0*!pi*den2(g1)) 
f(g2) = a(0)*(a(1)^(-a(2)))*(x(g2)^a(2)) + (a(3)*a(4))/(2.0*!pi*den1(g2)) + $
(fa*a(6))/(2.0*!pi*den2(g2))
...
c3_1 = (fa*a(6))/(2.0*!pi*den2(g1))
oplot, x(g1), c3_1, linestyle = 2, thick = 1
c3_2 = (fa*a(6))/(2.0*!pi*den2(g2))
