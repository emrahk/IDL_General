pro brk_pow_2lfffa, x, a, ff, f, pder
...
den_minus2 = (x - ff)^2 - (0.5*a(6))^2

f(g1) = a(0) +  (a(3)*a(4))/(2.0*!pi*den1(g1)) + $
(fa*a(6))/(2.0*!pi*den2(g1)) 
...
pder(g1,6) = (fa*den_minus2(g1))/(2.0*!pi*den2(g1)^2)
...
pder(g2,6) = (fa*den_minus2(g2))/(2.0*!pi*den2(g2)^2)
