pro fit_brpl_1lff,p,p_err,f_b,a1,a2,ff,fit,guess
...
modelname = 'brk_pow_1lff' ; the model name should also go here
...
oplot, x(g2), c2_2, linestyle = 2, thick = 1
 print,'which parameter you want to change, 5 to change freq., or 6 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
...
print, 'reduced chi^2 = ', total(chi), dof
