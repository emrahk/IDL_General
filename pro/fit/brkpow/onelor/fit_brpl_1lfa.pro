pro fit_brpl_1lfa,p,p_err,f_b,a1,a2,fa,fit,guess
...
modelname = 'brk_pow_1lfa' ; the model name should also go here
...
c2_1 = (fa*a(3))/(2.0*!pi*den(g1))
oplot, x(g1), c2_1, linestyle = 2, thick = 1
c2_2 = (fa*a(3))/(2.0*!pi*den(g2))
oplot, x(g2), c2_2, linestyle = 2, thick = 1

print,'which parameter you want to change, 5 to change amplitude, or 6 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
  ...
  5: begin
     print,fa,'  remember this is going to be fixed in curvefit'
     read,var
     fa=var
  end
...
guess=1
w = 1.0/(p_err^2)
yfit = curvefit_i(f_b, p, w, a, fa, chisqr, sigmaa, function_name = modelname)
