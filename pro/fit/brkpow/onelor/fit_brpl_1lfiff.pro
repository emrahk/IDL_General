pro fit_brpl_1lfiff,p,p_err,f_b,a1,a2,fi,ff,fit,guess
...
modelname = 'brk_pow_1lfiff' ; the model name should also go here
...
c2_1 = (a(2)*a(3))/(2.0*!pi*den(g1))
oplot, x(g1), c2_1, linestyle = 2, thick = 1
c2_2 = (a(2)*a(3))/(2.0*!pi*den(g2))
oplot, x(g2), c2_2, linestyle = 2, thick = 1

 print,'which parameter you want to change, 4 to change index, 5 to change freqor 6 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
