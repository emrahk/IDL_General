pro fit_brpl_1lfifffwfl,p,p_err,f_b,a,fi,ff,fw,fl,fit,guess
...
modelname = 'brk_pow_1lfifffwfl' ; the model name should also go here
...
oplot, x(g2), c2_2, linestyle = 2, thick = 1
 ...
 print,'which parameter you want to change, 2:index, 3:freq, 4:width, 5:level or 6 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
