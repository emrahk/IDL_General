...
den4 = (x - ff1)^2 + (0.5*a(13))^2
den_minus4 = (x - ff1)^2 - (0.5*a(13))^2

den5 = (x - ff2)^2 + (0.5*a(15))^2
den_minus5 = (x - ff2)^2 - (0.5*a(15))^2

f(g1) = a(0) +  (a(3)*a(4))/(2.0*!pi*den1(g1)) + $
(a(6)*a(7))/(2.0*!pi*den2(g1)) + (a(9)*a(10))/(2.0*!pi*den3(g1)) +$
(a(12)*a(13))/(2.0*!pi*den4(g1)) + (a(14)*a(15))/(2.0*!pi*den5(g1))

f(g2) = a(0)*(a(1)^(-a(2)))*(x(g2)^a(2)) + (a(3)*a(4))/(2.0*!pi*den1(g2)) + $
(a(6)*a(7))/(2.0*!pi*den2(g2)) + (a(9)*a(10))/(2.0*!pi*den3(g2)) + $
(a(12)*a(13))/(2.0*!pi*den4(g2)) + (a(14)*a(15))/(2.0*!pi*den5(g2)) 
...
pder(g1,12) = a(13)/(2.0*!pi*den4(g1))
pder(g1,13) = (a(12)*den_minus4(g1))/(2.0*!pi*den4(g1)^2)
;pder(g1,14) = (a(12)*a(13)*(x(g1)-ff))/(!pi*den4(g1)^2)
pder(g1,14) = a(15)/(2.0*!pi*den5(g1))
pder(g1,15) = (a(14)*den_minus5(g1))/(2.0*!pi*den5(g1)^2)
...
pder(g2,12) = a(13)/(2.0*!pi*den4(g2))
pder(g2,13) = (a(12)*den_minus4(g2))/(2.0*!pi*den4(g2)^2)
;pder(g2,14) = (a(12)*a(13)*(x(g2)-a(14)))/(!pi*den4(g2)^2)
pder(g2,14) = a(15)/(2.0*!pi*den5(g2))
pder(g2,15) = (a(14)*den_minus5(g2))/(2.0*!pi*den5(g2)^2)
