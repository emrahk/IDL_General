pro fit_brpl_5lff,p,p_err,f_b,a1,a2,a3,a4,a5,a6,ff1,ff2,fit,guess
...
modelname = 'brk_pow_5lffff' ; the model name should also go here

a = [a1,a2,a3,a4,a5,a6] ; guess for curvefit
guess=a
...
c6_1 = (a(14)*a(15))/(2.0*!pi*den5(g1))
oplot, x(g1), c6_1, linestyle = 2, thick = 1
c6_2 = (a(14)*a(15))/(2.0*!pi*den5(g2))
oplot, x(g2), c6_2, linestyle = 2, thick = 1
