pro fit_pl_1lfffifa,p,p_err,f_b,a,ff,fi,fa,fit,guess
...
modelname = 'pow_1lfffifa' ; the model name should also go here
...
print, 'level = ', fa,  '  fixed'
print, 'index = ', fi, '  fixed'
print, 'f_buency = ', ff, '  fixed'
print, 'frac_rms = ', sqrt(a(1))
print, 'frac_rms_err = ', sigmaa(1)/(2.0*sqrt(a(1)))
