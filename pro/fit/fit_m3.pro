...
.r model3
; model 3 is three Lorentzians
.r curvefit
.r rebin_geo

modelname = 'model3' ; the model name should also go here
fname = 'orbit'+orbit_number+'_'+band
step = 1.01 ; for rebinning
a = [3.e-2,2.0,0.1,1.e-2,0.1,2.6,1.e-2,0.05,5.2] ; guess for curvefit
f_low = 0.01 & f_high = 10.0 ; limits for calculating the fractional rms amplitude

print, 'freq_'+fname+'.dat'
