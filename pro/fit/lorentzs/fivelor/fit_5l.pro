pro fit_5l,p,p_err,f_b,a1,a2,a3,a4,a5,fit,guess,sig,rmsi,rmst,xwin=xwin,ywin=ywin,plty=plty,fvf=fvf
...
modelname = 'lor_5l' ; the model name should also go here
...
c_4 = (a(9)*a(10))/(2.0*!pi*den_4)
oplot, x, c_4, linestyle = 2, thick = 1

c_5 = (a(12)*a(13))/(2.0*!pi*den_5)
oplot, x, c_5, linestyle = 2, thick = 1

 print,'which parameter you want to change, or 15 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
...
if keyword_set(fvf) then begin
      oplot, x, x*c_4, linestyle = 2, thick = 1
endif else oplot, x, c_4, linestyle = 2, thick = 1

c_5 = (a(12)*a(13))/(2.0*!pi*den_5)
 
if keyword_set(fvf) then begin
      oplot, x, x*c_5, linestyle = 2, thick = 1
endif else oplot, x, c_5, linestyle = 2, thick = 1
...
print, 'frac_rms (3, -inf to inf) = ', sqrt(a(6)), sigmaa(6)/(2.0*sqrt(a(6)))
...
print, 'f_buency (4) = ', a(11), sigmaa(11)
print, 'frac_rms (4, -inf to inf) = ', sqrt(a(9)), sigmaa(9)/(2.0*sqrt(a(9)))
print, 'fwhm (4) =', a(10), sigmaa(10)
...
print, 'f_buency (5) = ', a(14), sigmaa(14)
print, 'frac_rms (5, -inf to inf) = ', sqrt(a(12)), sigmaa(12)/(2.0*sqrt(a(12)))
print, 'fwhm (5) =', a(13), sigmaa(13)
