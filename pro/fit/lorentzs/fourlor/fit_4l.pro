pro fit_4l,p,p_err,f_b,a1,a2,a3,a4,fit,guess,sig,rmsi,rmst,xwin=xwin,ywin=ywin,plty=plty,fvf=fvf
...
modelname = 'lor_4l' ; the model name should also go here
...
oplot, x, c_4, linestyle = 2, thick = 1
 ...
 print,'which parameter you want to change, or 12 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
