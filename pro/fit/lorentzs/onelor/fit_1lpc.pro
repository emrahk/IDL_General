pro fit_1lpc,p,p_err,f_b,a,fit,guess,sig,rmsi,rmst,xwin=xwin,ywin=ywin,plty=plty,fvf=fvf
...
modelname = 'lor_1lpc' ; the model name should also go here
...
c_1 = (a(0)*a(1))/(2.0*!pi*den)+a(3)
oplot, x, c_1, linestyle = 2, thick = 1

 print,'which parameter you want to change, or 4 to exit'
 read,ind
 case ind of
  0: begin
     print,a(0)
