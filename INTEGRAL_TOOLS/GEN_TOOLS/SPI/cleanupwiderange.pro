pro cleanupwiderange,data,hkdata,tracer,hktracer,prange=prange,det=det
...
plot,newtracer.time,newtracer.dt[det],yr=[0.1,0.35],$
/ystyle,/xstyle,ytitle='DT'

  oplot,[newtracer[0].time,newtracer[0].time],[0.,.35]
...
plot,newtracer.time,newtracer.acs_bw,yr=[50000,230000],$
/ystyle,/xstyle,ytitle='acs_bw'

  oplot,[newtracer[0].time,newtracer[0].time],[50000.,230000.]
  for i=0,(prange[1]-prange[0]) do begin
    oplot,[newtracer[long(total(hktracer[prange[0]:prange[0]+i].nel))-1L].time,$
           newtracer[long(total(hktracer[prange[0]:prange[0]+i].nel))-1L].time],$
           [50000.,230000.]
...
plot,newtracer.time,newtracer.acsd,yr=[0.1,0.22],$
/ystyle,/xstyle,ytitle='acsd'

  oplot,[newtracer[0].time,newtracer[0].time],[0.1,0.22]
  for i=0,(prange[1]-prange[0]) do begin
    oplot,[newtracer[long(total(hktracer[prange[0]:prange[0]+i].nel))-1L].time,$
           newtracer[long(total(hktracer[prange[0]:prange[0]+i].nel))-1L].time],$
           [0.1,.22]
