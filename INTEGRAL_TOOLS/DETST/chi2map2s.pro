pro chi2map2s,map1,map1_err,map2,map2_err,file=file,ps=ps,chi2

;this program finds chi^2 distribution of deviation of rates in pseudo
;detectors for one revolution with respect to another revolution. No
